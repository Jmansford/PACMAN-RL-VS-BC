...
# Training parameters
TRAINING_TIMESTEPS = 200000  # Number of steps to train for
...
TEST_RENDER = False  # Whether to render the game during testing
MODEL_PATHS = ["outputs/models/pacman_dqn", "outputs/models/logs/models/dqn_pacman_checkpoint_40000_steps"]
